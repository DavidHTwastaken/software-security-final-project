...
At Some Security, the server adds backslashes in front of dangerous characters (single quotes, double quotes, semi-colons).
...
At this level, the user input is passed as a parameter in a prepared statement.
